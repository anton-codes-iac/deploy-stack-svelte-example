...
resource "aws_vpc" "main" {
  ...
  tags = {
    Name = "deploy-stack-svelte-example-vpc"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "deploy-stack-svelte-example-public-subnet-${count.index + 1}"
  }
}
...
resource "aws_security_group" "alb" {
  name        = "deploy-stack-svelte-example-alb-sg"
...
resource "aws_security_group" "ecs_tasks" {
  name        = "deploy-stack-svelte-example-ecs-sg"
